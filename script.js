...
const field = document.querySelector("#color");
    field.insertAdjacentHTML("afterbegin",`<option selected>
    Please select a color
    </option>`);

// displays the shirt style that has been selected by the user
design.addEventListener("change", (e)=>{
    field.firstElementChild.selected = true;
...
const cardField = document.getElementsByTagName("option");
// adds desired error message if fields are not valid
if (cardField.value = "credit-card"){
if(!validCardNum){
  e.preventDefault();
